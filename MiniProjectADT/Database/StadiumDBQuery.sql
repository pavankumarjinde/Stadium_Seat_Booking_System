...
create table users(user_id serial primary key,user_name varchar(20) not null unique,user_pass varchar(20) not null,hint varchar(50),name varchar(50) not null,email varchar(40) not null,mobnum varchar(10) unique);
create table booking(user_id int references users(user_id),
...
INSERT INTO interenationalwest (seat_num) select * from seq_1_to_50;
