...
create table platinumseat(seat_num int primary key,statusofevent1 boolean ,statusofevent2 boolean,statusofevent3 boolean);
ALTER TABLE platinumseat ALTER statusofevent1 SET DEFAULT true;
ALTER TABLE platinumseat ALTER statusofevent2 SET DEFAULT true;
ALTER TABLE platinumseat ALTER statusofevent3 SET DEFAULT true;
create table royalbox(seat_num int primary key,statusofevent1 boolean,statusofevent2 boolean ,statusofevent3 boolean);
ALTER TABLE royalbox ALTER statusofevent1 SET DEFAULT true;
ALTER TABLE  royalbox ALTER statusofevent2 SET DEFAULT true;
ALTER TABLE  royalbox ALTER statusofevent3 SET DEFAULT true;
...
INSERT INTO platinumseat (seat_num) select * from seq_1_to_30;
INSERT INTO royalbox (seat_num) select * from seq_1_to_20;
INSERT INTO vipboxwest (seat_num) select * from  seq_1_to_20;
INSERT INTO vipboxeast (seat_num) select * from  seq_1_to_20;
INSERT INTO premiumseatwest (seat_num) select * from  seq_1_to_25;
INSERT INTO premiumseateast (seat_num) select * from   seq_1_to_25;
INSERT INTO corporateboxwest (seat_num) select * from  seq_1_to_25;
INSERT INTO corporateboxeast (seat_num) select * from  seq_1_to_25;
INSERT INTO interenationalwest (seat_num) select * from   seq_1_to_5;
INSERT INTO interenationaleast (seat_num) select * from  seq_1_to_50;
INSERT INTO generalwest (seat_num) select * from  seq_1_to_100;
INSERT INTO generaleast (seat_num) select * from   seq_1_to_100;
...
alter table platinum drop column statusofevent2;
